...
//  MEMS_Write(LIS302DL_FF_WU_CFG1_REG_ADDR, 0xD5);
//
//  // free-fall/wake-up threshold (7 bit)
//  MEMS_Write(LIS302DL_FF_WU_THS1_REG_ADDR, 0x14);
//
...
//  MEMS_Write(LIS302DL_FF_WU_DURATION1_REG_ADDR, 0x09);
  while (1)
  {
